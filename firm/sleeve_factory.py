...
CANDIDATE_SPECS: list[SleeveSpec] = [
    ...
    SleeveSpec(
        ...
        novel_reason=(
            ...
            "outer edges. SHORT: high[t] >= VAH - touch_tol*ATR "
            "AND close[t] strictly inside VA. LONG: low[t] <= "
            "VAL + touch_tol*ATR AND close[t] strictly inside "
            "VA. require_close_inside_va locked True. ATR "
            "period locked 20, known before the signal bar "
            "(atr.shift(1)). Fill t+1 open. Free search (3 "
            "only): lookback [20, 48], touch_tol [0.0, 0.10], "
            "va_frac [0.68, 0.70]. Not prior_poc_reclaim_fade "
        ...
        justification=(
            ...
            "searched lookback + touch_tol + va_frac only, is "

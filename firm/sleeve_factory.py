...
CANDIDATE_SPECS: list[SleeveSpec] = [
    ...
    SleeveSpec(
        ...
        novel_reason=(
            ...
            "prior_day_high and close_t < prior_day_high (preferably close "
            "inside prior day range). LONG when low_t <= prior_day_low and "
            "close_t > prior_day_low. Free params: touch_tol_atr (default 0) "
            "and require_close_inside. Not monday_range_sweep_reversal "
